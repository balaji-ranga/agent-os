...
check "README Browser Session" grep -q "browse_recipe_run" "$ROOT/README.md"
...
check "README documents AgentSystem recovery" grep -q '/admin/openclaw-recovery' "$ROOT/README.md"
