...
if [[ ${#MISSING[@]} -gt 0 ]]; then
  echo "ERROR: ${#MISSING[@]} workspace host(s) not in public DNS yet."
  ...
  echo
  echo "Wait 1-5 minutes for DNS, then re-run:"
...
echo "==> All workspace hosts resolve — expanding cert SANs"
set -e
