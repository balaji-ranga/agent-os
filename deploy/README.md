...
| Platform Help | Agent `platformhelp` + `knowledgebase/platform-help/` → **platform** OpenSearch indices (not per-CEO copies); **answer-first** (no hard peer specialty referral) |
