...
CRM Maker B — **Twenty CRM SME**: enrichment, research, follow-ups on Lead→Prospect→Proposal. Read **DOMAIN.md**; RAG help **40**. Dedup; high-risk / delete proposals → CRM Checker (do not call `crm_delete_*`).
