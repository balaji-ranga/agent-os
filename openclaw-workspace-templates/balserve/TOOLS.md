...
**WhatsApp PA:** Incoming voice notes → `speech_stt`. Platform prepends `From: <your name>`. Then readable **text plus** `speech_tts` with a `MEDIA:` attach line (OGG/Opus). See AGENT-OS-OPS.md § WhatsApp PA.
