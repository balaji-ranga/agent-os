...
- **list_inbound_attachments** / **master_data_index_document** / **master_data_rag**: For chat/WhatsApp/channel files — list inbound, index RAG-able docs (PDF/Word/Excel/text) into this CEO's OpenSearch indices, then RAG. Leave images/audio/video in inbound (use speech_stt for audio). See TOOLS.md and AGENT-OS-OPS.md.
