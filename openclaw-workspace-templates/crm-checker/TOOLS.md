...
Read workspace **DOMAIN.md** (Twenty CRM SME). Before approve/reject, **`master_data_rag`** query `Twenty CRM lead prospect Won order Checker`. Help **40** / **38**. List/RAG include Flolah Help (`corpus=platform-help`) even with no CEO uploads.
