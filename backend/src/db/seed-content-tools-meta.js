...
const BUILTIN_TOOLS = [
  ...
  {
    name: 'agent_goal_create',
    display_name: 'Create Multi-Intent Goal Plan',
  ...
  {
    name: 'agent_goal_list',
    display_name: 'List Goal Plans',
  ...
  {
    name: 'agent_goal_complete_step',
    display_name: 'Complete Goal Plan Step',
