...
const ERP_TOOLS_META = [
  ...
  },
  {
    ...
    method: 'POST',
    purpose: 'Create ERPNext Project (company-scoped).',
    model_used: '',
    enabled: 1,
    is_builtin: 1,
  },
  {
    ...
    method: 'POST',
    purpose: 'List ERPNext Tasks for company projects.',
    model_used: '',
    enabled: 1,
    is_builtin: 1,
  },
  {
    ...
    method: 'POST',
    purpose: 'Create ERPNext Task (subject required).',
    model_used: '',
    enabled: 1,
    is_builtin: 1,
  },
  {
    ...
    method: 'POST',
    purpose: 'List Sales Invoices for company (Invoice agent).',
    model_used: '',
    enabled: 1,
    is_builtin: 1,
  },
  {
    ...
    method: 'POST',
    purpose: 'Create Sales Invoice draft/doc for company.',
    model_used: '',
    enabled: 1,
    is_builtin: 1,
  },
  {
    ...
    method: 'POST',
    purpose: 'List Purchase Invoices for company.',
    model_used: '',
    enabled: 1,
    is_builtin: 1,
  },
  {
    ...
    method: 'POST',
    purpose: 'Create Purchase Invoice for company.',
    model_used: '',
    enabled: 1,
    is_builtin: 1,
  },
  {
    ...
    method: 'POST',
    purpose: 'List GL Entries for company (P&L agent).',
    model_used: '',
    enabled: 1,
    is_builtin: 1,
  },
  {
    ...
    method: 'POST',
    purpose: 'Run ERPNext Profit and Loss Statement for company (from_date/to_date).',
    model_used: '',
    enabled: 1,
    is_builtin: 1,
  },
