...
export function redactSecretsInString(text) {
  ...
  s = s.replace(
    /\b(TOOLS_API_KEY|AGENT_OS_INTERNAL_TOKEN|AGENT_OS_TOOL_BROKER_TOKEN|OPENCLAW_GATEWAY_TOKEN|OPENAI_API_KEY|OPENAI_PRIMARY_API_KEY|OPENAI_SECONDARY_API_KEY|ANTHROPIC_API_KEY|OPENROUTER_API_KEY|REPLICATE_API_TOKEN|USER_API_KEYS_KEK|EMAIL_INBOUND_WEBHOOK_SECRET|AGENT_OS_ADMIN_PASSWORD|WORKFLOW_SMTP_PASS)\b(\s*[:=]\s*)(\S+)/gi,
    '$1$2REDACTED'
  );
