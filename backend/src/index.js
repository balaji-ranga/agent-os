...
import companyObjectivesRoutes from './routes/company-objectives.js';
...
apiRouter.use('/company-objectives', companyObjectivesRoutes);
...
apiRouter.use('/ibkrnew-event-trader', ibkrNewEventTraderRoutes);
