      ...
      sso = {
        ...
        note:
          launch.mode === 'login_token_sso'
            ? 'Passwordless CRM login via Flolah session. The CRM iframe applies the exchanged token pair on the workspace host (same pattern as ERP). Twenty /verify is not used.'
