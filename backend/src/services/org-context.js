  ...
  return [
    ...
    },
    {
      ...
      lines: [
        ...
        '- **speech_tts** / **speech_stt**: Free Piper TTS and Whisper STT when the CEO asks to speak or transcribe (optional-voice). WhatsApp/web media is mirrored to `inbound/attachments/<file>` — use that relative path (or MEDIA:/root/.openclaw/media/inbound/…) with speech_stt or the Summarize inbound media attachment workflow. If you see “[whatsapp attachment unavailable]” (or Telegram equivalent): (1) call **list_inbound_attachments**, (2) pick the newest audio/video `relative_path`, (3) call **agent_workflow_trigger** for “Summarize inbound media attachment” with that path (or speech_stt then summarize). Do not stop at “unavailable” — bytes usually land in inbound within a few seconds.',
