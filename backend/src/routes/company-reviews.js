...
router.post('/:id/opinions/generate', wrapAsync(async (req, res) => res.json(await generateReviewOpinions({ ownerUserId: owner(req), reviewId: req.params.id, evidenceId: req.body?.evidence_id, ceoFeedback: req.body?.ceo_feedback }))));
