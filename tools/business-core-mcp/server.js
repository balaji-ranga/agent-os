...
const TOOL_ENDPOINT = {
  ...
  erp_get_company: '/api/tools/erp-get-company',
  erp_update_company: '/api/tools/erp-update-company',
  erp_list_fiscal_years: '/api/tools/erp-list-fiscal-years',
  erp_create_fiscal_year: '/api/tools/erp-create-fiscal-year',
