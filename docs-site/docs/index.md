...
6. [Company setup](/setup/company-setup) then [org](/setup/org-and-departments) and [people](/setup/people)
...
9. [Operate and grow](/operate/maker-checker) — approvals, [example stress test run](/operate/example-stress-test-run), budgets, troubleshooting
