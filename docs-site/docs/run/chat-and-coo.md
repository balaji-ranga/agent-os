...
A scored example of telling the COO the outcome first (seeded pipeline, live research, CRM approval path): [Example stress test run](../operate/example-stress-test-run.md).
