...
Some published workflows can **Download for Windows**: a local runner that executes laptop-side steps (files, localhost) while remote nodes still run on Flolah.
