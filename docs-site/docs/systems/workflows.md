...
Chat with **Workflow Builder** to add nodes, wire edges, validate, and publish in plain language. Use **Platform Help** to *explain* a node; use Workflow Builder to *change* the graph.
