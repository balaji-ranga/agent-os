...
**CRM** and **ERP** menu items appear when the matching provider is selected. Both load **in Flolah** (iframe), passwordless via your Flolah login. Stay on the Flolah page — do not type email or password into Twenty or ERPNext. Reloading **CRM** / **ERP** retries SSO. If the browser says the CRM page **moved or is temporarily down**, that host is waiting on TLS. Reload CRM after a minute. A **Bad Gateway** on the CRM sign-in hop is not the desk being down — reload **CRM**.
