...
| **Video content studio** | Industry pack `video_content`: chat **Content Orchestrator**, phrase **run video storyboard** (Story → Scene → Prompt → CEO gate). The approval Kanban card includes a scene summary and **PDF** on Artifacts. Help **41**. |
