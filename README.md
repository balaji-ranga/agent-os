...
| **Home chat** | `/` — COO chat by default; agent picker; history/browser panes; compose **microphone** / **Speak** / **phone** (Slow vs Realtime Caller); **OEI** KPI + explain popover (help **36** / **25** / **46**). On phones: overview first, **Chat** opens a full-screen sheet; history/browser icons open a side drawer (desktop unchanged). |
