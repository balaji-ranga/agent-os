...
| **BROWSER-SESSION-DESKTOP-LOCAL.md** | **Plan (single release):** Local Browser Worker zip (IBKR-pattern), owner dispatch for `browse_*`/recipes, no exclusive-lease multi-user Client Chrome. |
