...
| **NORTHSTAR-INDUSTRIAL-OKR-DEMO-SEED-PACK.md** | Versioned, executable OKR company demo seed pack: CEO/people/org, annual + quarterly objectives, workflows, CRM/ERP evidence, policies, budgets, preview/cleanup/reseed, VPS verification and rollback. |
...
| **platform-help/** | Curated CEO end-user Platform Help corpus. **Public website:** sequenced Docusaurus guide at `docs-site/` → `https://flolah.cloud/docs/` (open access, no operator secrets) plus blog/forum at `https://flolah.cloud/blog/`. In-app Platform Help RAG indexes this folder and automatically mirrors every sensitivity-scanned page under `docs-site/docs/`. |
