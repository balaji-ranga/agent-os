...
| [platform-help/28-scheduled-goals.md](./platform-help/28-scheduled-goals.md) | CEO help: scheduled goals (hourly/daily/weekdays/weekly; create/edit/pause; COO tools; multi-intent **goal plan mode**) |
