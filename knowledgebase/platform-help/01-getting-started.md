...
1. Open the Flolah site → **Register** (new CEO) or **Log in**. Public how-to (no login): [https://flolah.cloud/docs/](https://flolah.cloud/docs/). Public blog and forum: [https://flolah.cloud/blog/](https://flolah.cloud/blog/).
