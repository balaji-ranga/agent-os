...
- **CEO Approval** workflow nodes (and similar awaiting-confirmation cards) pause here until you approve or reject (with optional comment). Video storyboard runs attach a **PDF** (and HTML) on the card **Artifacts** tab so you can review the board before deciding.
