...
| **OpenConnector SaaS apps** | Workflow **Connector** node (Gmail, Slack, HubSpot, etc.) | OAuth token or vendor API key per app | **Connectors** UI + optional **API Keys** vault | Per app | About **1,300** apps via [Open Connector](https://openconnector.dev/#connectors); each connected app is its own external dependency. |
