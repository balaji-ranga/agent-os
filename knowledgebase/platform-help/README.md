...
| [42-social-research-business-discovery.md](./42-social-research-business-discovery.md) | **Social Researcher** + **Business Discovery** (Discover → Research → Track → Act, goal plan `agr-…`, research brief); Social Research MCP; Places API (New); Instaloader + **INSTAGRAM_SESSIONID**; X hydrate / **X_API_BYOK**; Knowledge `discovered_opportunities`; CRM Kanban only on Act |
