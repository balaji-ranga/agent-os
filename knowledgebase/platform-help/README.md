...
| [42-social-research-business-discovery.md](./42-social-research-business-discovery.md) | **Social Researcher** + **Business Discovery** on AgentExchange; Social Research MCP; Places API (New); Instaloader + **INSTAGRAM_SESSIONID**; X hydrate / **X_API_BYOK**; Knowledge `discovered_opportunities`; CRM Kanban handoff |
