...
| **Workflow Builder chat** | Natural-language builder: **any create/build-a-workflow ask creates a real graph and opens the editor** (curated recipes when they match; otherwise the model picks catalog nodes — employees / content tools / Connectors / MCP / Browser Session). Public upload/publish waits for CEO approval. |
