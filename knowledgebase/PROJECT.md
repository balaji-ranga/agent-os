...
| **Workflow Builder chat** | Natural-language builder: **any create/build-a-workflow ask compiles a real graph** (curated recipes when they match; otherwise employees / content tools / Connectors / MCP / Browser Session). Public upload/publish waits for CEO approval. |
