...
| **Pipeline under constraints** | COO outcome (40 verified prospects, ≥10 drafts, $75 cap, no invent, no unapproved send). Gate A seeded 10/10. Help **48**. Public: `/docs/operate/pipeline-under-constraints`. |
